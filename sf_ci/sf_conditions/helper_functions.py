...
def generate_image_list(end_date_str, intervals, image_prefix, parquet_prefix, metadata, column = 'desktop_CONUS_image_file'):
    ...
    for interval in intervals:
        ...
        if delta > max_delta:
            ...
            #s3_image_list is a list of all the image urls from the metadata file, "NA" will be listed if the image does not exist
            ...
            s3_parquet_list = metadata[metadata['date'].isin(date_list)]["parquet_file"].tolist()
            ...
            # parquet_download_list contains all the data urls needed to make the images in image_make_list, NA means it needs to be generated
            image_download_list = []
            image_make_list = []
            parquet_list = []
